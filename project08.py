############################################################################
# Project 08: GET/PUT/POST/PUSH tester, and @property decorators leaning tool
# It also includes image handling and pillow resizer.
# Profile pictures are generated by thispersondoesnotexist.com
################
...
project08 = Blueprint('project08', __name__)
##################
@project08.route('/')
...
############################################################################
# Serving Images
@project08.route('/data/08/<filename>')
def serve_image(filename):

    directory = os.path.abspath(os.path.join(os.getcwd(), "data", "08"))
    return send_from_directory(directory, filename)
#################
# TMP img path for new profiles
@project08.route('/profile/new/<int:client_id>', methods=['GET'])
...
#################
# IMG Profiler, from data/08/, or generated in NewProfile cases
...
#################
# GET the profiles JSON
############################################################################
@project08.route('/profile', methods=['GET'])
def getter_users():
...
#################
# POST in profiles JSON
############################################################################
@project08.route('/profile', methods=['POST'])
def setter_users():
...
#################
# PUT into profiles JSON
############################################################################
@project08.route('/profile/<int:client_id>', methods=['PUT'])
...
#################
# DELETE in the profiles JSON
############################################################################
@project08.route('/profile/<int:client_id>', methods=['DELETE'])
...
class UserData:
    ...
    def img_profile(self):
        ...
        if self._client_id == "default":
            return url_for('static', filename='08/default.jpeg')
